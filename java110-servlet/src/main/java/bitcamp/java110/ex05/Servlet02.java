...
// GenericServlet을 직접 상속 받는 것 보다 MyHttpServlet 클래스를 상속 받으면
// HttpServletRequest, HttpservletResponse를 파라미터로 받는 service()를 오버라이딩 할 수 있다.
// 그래서 프로그래밍 하기 편하다!
@WebServlet("/ex05/servlet02")
public class Servlet02 extends MyHttpServlet2 {
    ...
    public void service(HttpServletRequest req, HttpServletResponse res) 
        ...
        String method = req.getMethod();// get인지 post인지 구분해줌
