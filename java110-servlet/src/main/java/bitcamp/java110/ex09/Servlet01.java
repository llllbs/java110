...
public class Servlet01 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) 
        ...
        if(!op.equals("+")) {
            ...
            // -> out.println()과 같은 출력문을 호출하면 즉시 클라이언트로 출력하는 것이 아니라 버퍼로 출력한다.
            ...
            // primitive type은  instance가 아님 -> 오토 박싱
            req.setAttribute("b", b);
            
/*            int v1 = 100;
            Integer v2 = Integer.valueOf(a);
            Integer v3 = v1;// auto boxing
    ...
    // -> URL에서 '+' 문자는 공백을 의미하기 때문에 서버에서 값을 꺼내면(getParameter() 호출) 공백이 리턴된다.
