...
public class Filter02 implements Filter {
    ...
    public Filter02() {
        System.out.println("Filter02.Filter01() 호출됨.");
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        // 클라이언트가 요청한 서블릿을 실행하기 전에 해당 URL에 등록한 필터를 실행한다.
        // 이때 이 메서드가 호출된다. 서블릿을 실행하기 전, 후에 수행해야 할 작업이 있다면 이 메서드에서 실행한다.
        // 예)
        // - 클라이언트가 암호화해서 보낸 데이터를 서블릿이 사용할 수 있도록 암호 해제 하기
