 ...
 * -> 쿠키의 사용 기간을 지정하지 않으면, 웹 브라우저는 메모리에 임시 보관한다.
 *    그래서 웹 브라우저를 닫으면 해당 쿠키는 버려진다.
 * -> 쿠키의 사용 기간을 지정하면, 웹 브라우저는 별도의 파일에 보관한다.
...
Set-Cookie: age=12; Max-Age=60; Expires=Mon, 01-Oct-2018 03:35:08 GMT; Path=/ <- 종료 날짜 지정됨
Set-Cookie: working=true; Max-Age=86400; Expires=Tue, 02-Oct-2018 03:34:08 GMT; Path=/
Content-Type: text/html;charset=UTF-8
Content-Length: 140
Date: Mon, 01 Oct 2018 03:34:08 GMT
         */
