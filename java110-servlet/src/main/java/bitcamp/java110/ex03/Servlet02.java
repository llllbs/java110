...
public class Servlet02 extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        // -> 또한 응답할때 Content-Type이라는 응답헤더를 추가한다.
        // -> 웹 브라우저는 Content-Type 응답헤더의 정보에 따라
        //    웹서버가 보낸 콘텐트를 처리한다.
        ...
        // -> 예)
        // -> ASCII     - 7bit; 미국 표준이다
        //    ISO-8859  - 1(ISO-Latin-1) - 8bit; 국제 표준이다
        //    EUC-KR    - 16비트; 국제 표준이다. 한글 2350자가 정의됨
        //    조합형                - 16비트; 아래아한글 규칙, 초성(5), 중성(5), 중성(5)로 표현
        //                3만자 이상의 모든 한글 문자를 표기할 수 있다.
        //    MS949(CP949) - 16비트; MS OS의 코드표, EUC-KR(2350)+8822 = 11172자 
        //    Unicode   - 16비트, 국제 표준이다.
        //                한글은 11172자가 정의되어 있다.
        //                영어도 2바이트로 표현된다.
        //    UTF-8     - 1 ~ 4 바이트로 문자 표현, 국제 표준이다.
        //                유니코드의 변형이다.
        //                한글은 규칙에 따라 3바이트로 표현한다.
        //                영어는 ISO-8859-1 코드 그대로 1바이트로 표현된다
        // 국제 표준만 사용한다
