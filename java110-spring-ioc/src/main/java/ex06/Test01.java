...
public class Test01 {
    public static void main(String[] args) {
        ...
        // 공장을 통해서 객체를 만들 때는 getBean()을 호출 할 때 생성한다.
        Engine e4 = (Engine)iocContainer.getBean("e4");
        System.out.println(e4);
        
        // 공장을 통해서 객체를 생성한 후 해당 이름으로 저장하면, 같은 이름에 대해서는 매번 객체를 새로 만들지 않는다
        Engine e4x = (Engine)iocContainer.getBean("e4");
        System.out.println(e4);
        
        // getBean()을 호출할 때 객체 이름이 다르면 공장을 통해 새 객체를 만들어 리턴한다
        Engine e5 = (Engine)iocContainer.getBean("e5");
        System.out.println(e5);
        
        // 공장을 통해 만들어진 객체가 있을 경우에는 다시 만들지 않는다
        ...
        // 다른 개발자가 헷갈려 하지 않도록 클래스 이름 뒤에 FactoryBean을 붙이는 것이 좋다
