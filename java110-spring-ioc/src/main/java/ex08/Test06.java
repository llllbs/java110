...
//    JDK에 기본으로 포함되어 있지 않기 때문에 JSR-20명세에 따라 작성된 외부 라이브러리를 추가해야 한다
//    Mvnrepository.com에서 "javax.annotation"으로 검색하라!
//
//  JSR(Java Specification Requests)?
//  -> JCP에서 JDK에 포함시키기를 요구하는 명세이다
//  -> JCP에서 제안한다
//  -> JSR에 따라 외부 개발자들이 라이브러리를 만들어 사용하다가 많은 호응이 있으면 JDK에 정식으로 추가된다
//
//  JCP(Java Community Process)?
//  -> 자바 기술에 대한 표준을 정의하는 모임
//  -> 오라클, 마이크로소프트, IBM, 페이스북, 삼성, LG등 유수 IT기업이 참여하고 있다
package ex08;
