...
// 이 애플릿케이션의 특정 URL에 대해 톰캣 서버가 이 서블릿을 찾을 수 있도록 등록한다.
...
public class ServerApp implements Servlet {
    ...
    public void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {
        // 서블릿 컨테이너는 클라이언트 요청이 들어올때 마다 이 메서드를 호출한다
    ...
    public void destroy() {
        ...
        // 왜? 이 서블릿이 사용했던 자원을 해제시켜 메모리를 줄일 수 있도록 하기 위함이다.
