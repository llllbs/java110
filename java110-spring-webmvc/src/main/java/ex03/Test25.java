...
public class Test25 {
    ...
    // 테스트:
    //     http://localhost:8888/app/ex03/test25/search/sonata/red/auto/year
   
    @RequestMapping("search/{car}/{color}/{auto}/{year}")
    public String m1(@PathVariable String car
    ...
    // 1) XML 설정
    //    @MatrixVariable 애노테이션을 사용하려면 스프링 설정에서 활성화 시켜야한다
    ...
    //
    // 테스트:
    //     http://localhost:8888/app/ex03/test25/search2/car=sonata;color=red;auto=true;year=1000
    //
   
    @RequestMapping(value="search2/{value}"
            ,produces="text/plain;charset=UTF-8")
    public String m2(@PathVariable String value
    ...
    // 테스트:
    //     http://localhost:8888/app/ex03/test25/search3/model/car=sonata;color=red/spec/auto=true;year=1000
    //
    ...
    // 테스트:
    //     http://localhost:8888/app/ex03/test25/search4/car/model=sonata;year=2013/tire/model=bittire;year=2013
    //
    
    @RequestMapping(value="search4/car/{value1}/tire/{value2}"
            ,produces="text/plain;charset=UTF-8")
    public String m4(
            // PathVariable이 다르고, 매트릭스 변수 이름이 같을때?
    ...
    //
    // 테스트:
    //     http://localhost:8888/app/ex03/test25/search5/{l1:[0-9][0-9]}
    //                                                   {l2:[0-9][0-9]}
    //                                                   {l3:[0-9][0-9]}
    //                                                   {l4:[0-9][0-9]}
