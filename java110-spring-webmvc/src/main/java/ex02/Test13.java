...
public class Test13 {
    ...
    @RequestMapping("m1")
    public String m1(@RequestParam(name="name") String name// name과 value는 같다
    ...
    // 주의!
    // 파라미터 타입이 String이 아닌 경우, null을 다른 타입으로 바꿀 수 없기 대문에 오류가 발생한다
    
    @RequestMapping("m2")
    public String m2(@RequestParam(name="name", required=false) String name
    ...
    @RequestMapping("m3")
    public String m3(@RequestParam(name="name", required=false) String name
    ...
    @RequestMapping("m4")
    public String m4(@RequestParam(required=false) String name
